    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        ...
                        @elseif(!empty($event->banner_url))
                            <img src="{{ asset('storage/'.$event->banner_url) }}" class="w-16 h-20 rounded-xl object-cover shadow-sm" alt="Poster">
                        @else
                            <div class="w-16 h-20 rounded-xl bg-slate-100 flex items-center justify-center text-[10px] text-slate-400 border border-slate-200 font-bold uppercase text-center">
                                No<br>Pic
                            </div>
                        @endif
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-8 py-12 text-center text-slate-400 font-medium bg-slate-50/50">
